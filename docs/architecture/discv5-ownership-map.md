...
| DiscV5 tests after migration | 307 | 431 after request/response/retry/challenge ledger canonicalization, exact admission correlation, initial-response and response-source-handshake generation preflights, compact in-place handshake rollback, and runtime/auth race tracers |
